...
const Header = ({ onNavigateToPricing, onNavigateToHome }) => {
  ...
  const handleNavClick = (href, e) => {
    ...
    // If on pricing page, navigate to home first, then scroll to section
    if (onNavigateToHome && href !== 'pricing') {
      onNavigateToHome();
      // Small delay to allow navigation to complete, then scroll
      setTimeout(() => {
        ...
        <div className="relative flex items-center justify-center h-20 pl-8 sm:pl-12 lg:pl-40">
          ...
          <div className="flex items-center gap-10">
            ...
            <div className="flex items-center">
              <Logo horizontal={true} size="default" showAgency={false} />
            </div>
          ...
          >
            {navItems.map((item) => (
              <button
                ...
                // className="block px-4 py-3 rounded-lg text-base font-medium text-gray-300 hover:bg-purple-500/20 hover:text-white transition-all bg-transparent border-none cursor-pointer text-left pl-40 w-full"
